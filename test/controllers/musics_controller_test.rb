...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { duration_seconds: @music.duration_seconds, name: @music.name } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { duration_seconds: @music.duration_seconds, name: @music.name } }
